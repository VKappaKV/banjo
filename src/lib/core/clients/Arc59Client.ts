...
export const APP_SPEC: Arc56Contract = {
  ...
  methods: [
    ...
    },
    {
      ...
      args: [{ name: "asa", type: "uint64", desc: "The ASA to opt into" }],
      returns: { type: "void" },
      events: [],
...
export abstract class Arc59ParamsFactory {
  ...
  static arc59GetSendAssetInfo(
    ...
    return {
      ...params,
      method:
        "arc59_getSendAssetInfo(address,uint64)(uint64,uint64,bool,bool,uint64,uint64)" as const,
  ...
  public async deploy(params: Arc59DeployParams = {}) {
    const result = await this.appFactory.deploy({
      ...
      createParams: params.createParams?.method
        ? Arc59ParamsFactory.create._resolveByMethod(params.createParams)
        : params.createParams
...
export class Arc59Client {
  ...
  readonly params = {
    ...
    arc59OptRouterIn: (
      ...
      return this.appClient.params.call(
        Arc59ParamsFactory.arc59OptRouterIn(params)
      );
    },
    ...
    arc59GetOrCreateInbox: (
      ...
      return this.appClient.params.call(
        Arc59ParamsFactory.arc59GetOrCreateInbox(params)
      );
    },
    ...
    arc59GetSendAssetInfo: (
      ...
      return this.appClient.params.call(
        Arc59ParamsFactory.arc59GetSendAssetInfo(params)
      );
    },
    ...
    arc59SendAsset: (
      ...
      return this.appClient.params.call(
        Arc59ParamsFactory.arc59SendAsset(params)
      );
    },
    ...
    arc59GetInbox: (
      ...
      return this.appClient.params.call(
        Arc59ParamsFactory.arc59GetInbox(params)
      );
    },
    ...
    arc59ClaimAlgo: (
      ...
      return this.appClient.params.call(
        Arc59ParamsFactory.arc59ClaimAlgo(params)
      );
    },
  };
  ...
  readonly createTransaction = {
    ...
    arc59Claim: (
      ...
      return this.appClient.createTransaction.call(
        Arc59ParamsFactory.arc59Claim(params)
      );
    },
    ...
    arc59Reject: (
      ...
      return this.appClient.createTransaction.call(
        Arc59ParamsFactory.arc59Reject(params)
      );
    },
  ...
  public newGroup(): Arc59Composer {
    ...
    return {
      ...
      arc59OptRouterIn(
        ...
        promiseChain = promiseChain.then(async () =>
          composer.addAppCallMethodCall(
            await client.params.arc59OptRouterIn(params)
          )
        );
      ...
      arc59GetOrCreateInbox(
        ...
        promiseChain = promiseChain.then(async () =>
          composer.addAppCallMethodCall(
            await client.params.arc59GetOrCreateInbox(params)
          )
        );
        resultMappers.push((v) =>
          client.decodeReturnValue("arc59_getOrCreateInbox(address)address", v)
        );
        return this;
      },
      /**
      ...
      arc59GetSendAssetInfo(
        ...
        promiseChain = promiseChain.then(async () =>
          composer.addAppCallMethodCall(
            await client.params.arc59GetSendAssetInfo(params)
          )
        );
        resultMappers.push((v) =>
      ...
      arc59SendAsset(
        ...
        promiseChain = promiseChain.then(async () =>
          composer.addAppCallMethodCall(
            await client.params.arc59SendAsset(params)
          )
        );
        resultMappers.push((v) =>
          client.decodeReturnValue(
      ...
      arc59Claim(
        ...
        promiseChain = promiseChain.then(async () =>
          composer.addAppCallMethodCall(await client.params.arc59Claim(params))
        );
        resultMappers.push(undefined);
        return this;
      },
      ...
      arc59Reject(
        ...
        promiseChain = promiseChain.then(async () =>
          composer.addAppCallMethodCall(await client.params.arc59Reject(params))
        );
        resultMappers.push(undefined);
        return this;
      },
      ...
      arc59GetInbox(
        ...
        promiseChain = promiseChain.then(async () =>
          composer.addAppCallMethodCall(
            await client.params.arc59GetInbox(params)
          )
        );
        resultMappers.push((v) =>
          client.decodeReturnValue("arc59_getInbox(address)address", v)
        );
        return this;
      },
      /**
      ...
      arc59ClaimAlgo(
        ...
        promiseChain = promiseChain.then(async () =>
          composer.addAppCallMethodCall(
            await client.params.arc59ClaimAlgo(params)
          )
        );
        resultMappers.push(undefined);
        return this;
...
export type Arc59Composer<TReturns extends [...any[]] = []> = {
  ...
  arc59SendAsset(
    ...
    [
      ...TReturns,
      Arc59Returns["arc59_sendAsset(axfer,address,uint64)address"] | undefined
    ]
  >;
  ...
  arc59GetInbox(
    ...
    [...TReturns, Arc59Returns["arc59_getInbox(address)address"] | undefined]
  >;
