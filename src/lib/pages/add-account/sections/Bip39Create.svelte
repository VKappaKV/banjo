...
<div class="grid gap-4">
	<div class="flex items-center gap-3">
		...
		<h2 class="text-xl font-semibold tracking-tight">New BIP39 Seed</h2>
	</div>
	...
	{#if step === "warning"}
		<Card.Root>
			<Card.Header>
				...
				<Card.Description>
					You are about to generate a new BIP39 seed phrase. This seed can derive multiple HD accounts. Write down the mnemonic and keep it safe — it is the only way to recover your HD accounts.
				</Card.Description>
			</Card.Header>
	...
	{:else if step === "done"}
		<Card.Root>
			...
			<Card.Footer class="flex gap-2">
				...
				<Button variant="outline" onclick={() => { step = "warning"; passphrase = ""; passphraseConfirm = ""; generatedMnemonic = ""; seedId = null; }}>
					Create Another
				</Button>
			</Card.Footer>
		</Card.Root>
