...
<div class="grid gap-4">
	<div class="flex items-center gap-3">
		...
		<h2 class="text-xl font-semibold tracking-tight">Watch Account</h2>
	</div>

	<Card.Root>
		<Card.Header>
			<Card.Title>Add an address to watch</Card.Title>
			<Card.Description>You will be able to see the balance and assets of this address without importing any keys.</Card.Description>
		</Card.Header>
		...
		<Card.Footer class="flex gap-2">
			<Button onclick={handleAdd} disabled={!address.trim()}>Add Watch Account</Button>
			{#if success}
