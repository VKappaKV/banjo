<script lang="ts">
	...
	async function handleImport() {
		...
		if (words.length !== 25) {
			error = "Algorand mnemonics are exactly 25 words. Found " + words.length + ".";
			return;
		}
...
<div class="grid gap-4">
	<div class="flex items-center gap-3">
		...
		<h2 class="text-xl font-semibold tracking-tight">Hot Mnemonic Import</h2>
	</div>

	<Card.Root>
		<Card.Header>
			<Card.Title>Paste or type your 25-word mnemonic</Card.Title>
			<Card.Description>This key will be stored in your browser's encrypted key storage.</Card.Description>
		</Card.Header>
