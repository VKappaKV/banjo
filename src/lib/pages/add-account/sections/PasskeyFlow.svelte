...
<div class="grid gap-4">
  <div class="flex items-center gap-3">
    ...
    <h2 class="text-xl font-mono tracking-tight">Passkey Account</h2>
  </div>
  ...
  {#if step === "choose"}
    <Card.Root>
      <Card.Header>
        ...
        <Card.Description>
          Use your device's biometric or PIN authentication to access or create
          a passkey-protected seed.
        </Card.Description>
      </Card.Header>
      ...
      <Card.Footer class="flex gap-2">
        ...
        <Button variant="outline" onclick={showRegisterWarning}
  ...
  {:else if step === "register-warning"}
    <Card.Root>
      <Card.Header>
        ...
        <Card.Description>
          Registering a new passkey creates a new seed. If you already have a
          passkey for Banjo, registering again will create a different seed.
          Make sure you want to create a new one.
        </Card.Description>
      </Card.Header>
      <Card.Footer>
  ...
  {:else if step === "restoring" || step === "registering"}
    <Card.Root>
      <Card.Header>
        <Card.Title
          >{step === "restoring" ? "Restoring" : "Registering"} Passkey</Card.Title
        >
        <Card.Description
          >Follow your device's authentication prompt.</Card.Description
        >
      </Card.Header>
    </Card.Root>
  {:else if step === "done"}
